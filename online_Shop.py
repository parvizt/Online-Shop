...
class OnlineShopDatabaseCreator:
    ...
    def create_database(self):
        try:
            conn = pyodbc.connect('Driver={SQL Server};Server=DESKTOP-2EA2N5I;Database=Online '
                                  'Shop;Trusted_Connection=yes;')
            cursor = conn.cursor()
            ...
            cursor.execute('''
                CREATE TABLE Products (
                    ...
                    Price DECIMAL(10, 2),
                    Sold_Pieces NVARCHAR(50),
                    Bought_Pieces NVARCHAR(50),
            ...
            # Continuing to create tables for Orders, OrderDetails, Payment, Reviews, Categories, and Brands
...
if __name__ == "__main__":
    ...
    app = OnlineShopDatabaseCreator(root)
    root.mainloop()
>>>>>>> e314023e1fc2558a6ada415e680d67998020d2a4
